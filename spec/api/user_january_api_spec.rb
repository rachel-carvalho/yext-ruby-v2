...
# Unit tests for YextClient::UserJanuaryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserJanuaryApi' do
  before do
    # run before each test
    @instance = YextClient::UserJanuaryApi.new
  end
  ...
  describe 'test an instance of UserJanuaryApi' do
    it 'should create an instact of UserJanuaryApi' do
      expect(@instance).to be_instance_of(YextClient::UserJanuaryApi)
    end
  end
