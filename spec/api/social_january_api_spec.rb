...
# Unit tests for YextClient::SocialJanuaryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SocialJanuaryApi' do
  before do
    # run before each test
    @instance = YextClient::SocialJanuaryApi.new
  end
  ...
  describe 'test an instance of SocialJanuaryApi' do
    it 'should create an instact of SocialJanuaryApi' do
      expect(@instance).to be_instance_of(YextClient::SocialJanuaryApi)
    end
  end
