...
# Unit tests for YextClient::InlineResponse20027
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20027' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20027.new
  end
  ...
  describe 'test an instance of InlineResponse20027' do
    it 'should create an instact of InlineResponse20027' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20027)
    end
  end
