...
# Unit tests for YextClient::InlineResponse20014Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20014Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20014Response.new
  end
  ...
  describe 'test an instance of InlineResponse20014Response' do
    it 'should create an instact of InlineResponse20014Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20014Response)
    end
  end
