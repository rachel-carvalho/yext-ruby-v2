...
# Unit tests for YextClient::InlineResponse20026Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20026Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20026Response.new
  end
  ...
  describe 'test an instance of InlineResponse20026Response' do
    it 'should create an instact of InlineResponse20026Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20026Response)
    end
  end
