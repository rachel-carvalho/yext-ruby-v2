...
# Unit tests for YextClient::GoogleCategory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GoogleCategory' do
  before do
    # run before each test
    @instance = YextClient::GoogleCategory.new
  end
  ...
  describe 'test an instance of GoogleCategory' do
    it 'should create an instact of GoogleCategory' do
      expect(@instance).to be_instance_of(YextClient::GoogleCategory)
    end
  end
