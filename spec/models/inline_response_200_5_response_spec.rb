...
# Unit tests for YextClient::InlineResponse2005Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2005Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse2005Response.new
  end
  ...
  describe 'test an instance of InlineResponse2005Response' do
    it 'should create an instact of InlineResponse2005Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse2005Response)
    end
  end
