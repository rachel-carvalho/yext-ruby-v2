...
# Unit tests for YextClient::EventSection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventSection' do
  before do
    # run before each test
    @instance = YextClient::EventSection.new
  end
  ...
  describe 'test an instance of EventSection' do
    it 'should create an instact of EventSection' do
      expect(@instance).to be_instance_of(YextClient::EventSection)
    end
  end
