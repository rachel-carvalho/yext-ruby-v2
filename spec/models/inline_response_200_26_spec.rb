...
# Unit tests for YextClient::InlineResponse20026
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20026' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20026.new
  end
  ...
  describe 'test an instance of InlineResponse20026' do
    it 'should create an instact of InlineResponse20026' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20026)
    end
  end
