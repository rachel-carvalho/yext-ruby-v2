...
# Unit tests for YextClient::BioSection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BioSection' do
  before do
    # run before each test
    @instance = YextClient::BioSection.new
  end
  ...
  describe 'test an instance of BioSection' do
    it 'should create an instact of BioSection' do
      expect(@instance).to be_instance_of(YextClient::BioSection)
    end
  end
