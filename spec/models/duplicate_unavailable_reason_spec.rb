...
# Unit tests for YextClient::DuplicateUnavailableReason
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DuplicateUnavailableReason' do
  before do
    # run before each test
    @instance = YextClient::DuplicateUnavailableReason.new
  end
  ...
  describe 'test an instance of DuplicateUnavailableReason' do
    it 'should create an instact of DuplicateUnavailableReason' do
      expect(@instance).to be_instance_of(YextClient::DuplicateUnavailableReason)
    end
  end
