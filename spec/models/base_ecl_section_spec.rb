...
# Unit tests for YextClient::BaseEclSection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BaseEclSection' do
  before do
    # run before each test
    @instance = YextClient::BaseEclSection.new
  end
  ...
  describe 'test an instance of BaseEclSection' do
    it 'should create an instact of BaseEclSection' do
      expect(@instance).to be_instance_of(YextClient::BaseEclSection)
    end
  end
