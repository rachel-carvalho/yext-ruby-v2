...
# Unit tests for YextClient::InlineResponse2009Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2009Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse2009Response.new
  end
  ...
  describe 'test an instance of InlineResponse2009Response' do
    it 'should create an instact of InlineResponse2009Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse2009Response)
    end
  end
