...
# Unit tests for YextClient::ContentListPhoto
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContentListPhoto' do
  before do
    # run before each test
    @instance = YextClient::ContentListPhoto.new
  end
  ...
  describe 'test an instance of ContentListPhoto' do
    it 'should create an instact of ContentListPhoto' do
      expect(@instance).to be_instance_of(YextClient::ContentListPhoto)
    end
  end
