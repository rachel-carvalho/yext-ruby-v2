...
# Unit tests for YextClient::InlineResponse20018Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20018Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20018Response.new
  end
  ...
  describe 'test an instance of InlineResponse20018Response' do
    it 'should create an instact of InlineResponse20018Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20018Response)
    end
  end
