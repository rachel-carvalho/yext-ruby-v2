...
# Unit tests for YextClient::ResponseMeta
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseMeta' do
  before do
    # run before each test
    @instance = YextClient::ResponseMeta.new
  end
  ...
  describe 'test an instance of ResponseMeta' do
    it 'should create an instact of ResponseMeta' do
      expect(@instance).to be_instance_of(YextClient::ResponseMeta)
    end
  end
