...
# Unit tests for YextClient::InlineResponse2002Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2002Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse2002Response.new
  end
  ...
  describe 'test an instance of InlineResponse2002Response' do
    it 'should create an instact of InlineResponse2002Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse2002Response)
    end
  end
