...
# Unit tests for YextClient::InlineResponse2014Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2014Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse2014Response.new
  end
  ...
  describe 'test an instance of InlineResponse2014Response' do
    it 'should create an instact of InlineResponse2014Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse2014Response)
    end
  end
