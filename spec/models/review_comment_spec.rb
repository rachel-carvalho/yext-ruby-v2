...
# Unit tests for YextClient::ReviewComment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReviewComment' do
  before do
    # run before each test
    @instance = YextClient::ReviewComment.new
  end
  ...
  describe 'test an instance of ReviewComment' do
    it 'should create an instact of ReviewComment' do
      expect(@instance).to be_instance_of(YextClient::ReviewComment)
    end
  end
