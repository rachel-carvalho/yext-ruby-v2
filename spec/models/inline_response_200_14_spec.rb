...
# Unit tests for YextClient::InlineResponse20014
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20014' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20014.new
  end
  ...
  describe 'test an instance of InlineResponse20014' do
    it 'should create an instact of InlineResponse20014' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20014)
    end
  end
