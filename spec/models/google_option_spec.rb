...
# Unit tests for YextClient::GoogleOption
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GoogleOption' do
  before do
    # run before each test
    @instance = YextClient::GoogleOption.new
  end
  ...
  describe 'test an instance of GoogleOption' do
    it 'should create an instact of GoogleOption' do
      expect(@instance).to be_instance_of(YextClient::GoogleOption)
    end
  end
