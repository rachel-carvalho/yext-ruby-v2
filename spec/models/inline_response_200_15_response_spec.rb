...
# Unit tests for YextClient::InlineResponse20015Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20015Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20015Response.new
  end
  ...
  describe 'test an instance of InlineResponse20015Response' do
    it 'should create an instact of InlineResponse20015Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20015Response)
    end
  end
