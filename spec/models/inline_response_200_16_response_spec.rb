...
# Unit tests for YextClient::InlineResponse20016Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20016Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20016Response.new
  end
  ...
  describe 'test an instance of InlineResponse20016Response' do
    it 'should create an instact of InlineResponse20016Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20016Response)
    end
  end
