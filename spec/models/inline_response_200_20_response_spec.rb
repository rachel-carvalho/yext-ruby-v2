...
# Unit tests for YextClient::InlineResponse20020Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20020Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20020Response.new
  end
  ...
  describe 'test an instance of InlineResponse20020Response' do
    it 'should create an instact of InlineResponse20020Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20020Response)
    end
  end
