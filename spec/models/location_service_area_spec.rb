...
# Unit tests for YextClient::LocationServiceArea
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LocationServiceArea' do
  before do
    # run before each test
    @instance = YextClient::LocationServiceArea.new
  end
  ...
  describe 'test an instance of LocationServiceArea' do
    it 'should create an instact of LocationServiceArea' do
      expect(@instance).to be_instance_of(YextClient::LocationServiceArea)
    end
  end
