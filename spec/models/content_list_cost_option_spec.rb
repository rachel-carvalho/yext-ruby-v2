...
# Unit tests for YextClient::ContentListCostOption
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContentListCostOption' do
  before do
    # run before each test
    @instance = YextClient::ContentListCostOption.new
  end
  ...
  describe 'test an instance of ContentListCostOption' do
    it 'should create an instact of ContentListCostOption' do
      expect(@instance).to be_instance_of(YextClient::ContentListCostOption)
    end
  end
