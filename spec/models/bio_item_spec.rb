...
# Unit tests for YextClient::BioItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BioItem' do
  before do
    # run before each test
    @instance = YextClient::BioItem.new
  end
  ...
  describe 'test an instance of BioItem' do
    it 'should create an instact of BioItem' do
      expect(@instance).to be_instance_of(YextClient::BioItem)
    end
  end
