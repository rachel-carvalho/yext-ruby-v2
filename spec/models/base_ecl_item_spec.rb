...
# Unit tests for YextClient::BaseEclItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BaseEclItem' do
  before do
    # run before each test
    @instance = YextClient::BaseEclItem.new
  end
  ...
  describe 'test an instance of BaseEclItem' do
    it 'should create an instact of BaseEclItem' do
      expect(@instance).to be_instance_of(YextClient::BaseEclItem)
    end
  end
