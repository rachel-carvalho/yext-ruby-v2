...
# Unit tests for YextClient::InlineResponse20023
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20023' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20023.new
  end
  ...
  describe 'test an instance of InlineResponse20023' do
    it 'should create an instact of InlineResponse20023' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20023)
    end
  end
