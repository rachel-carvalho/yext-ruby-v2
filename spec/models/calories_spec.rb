...
# Unit tests for YextClient::Calories
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Calories' do
  before do
    # run before each test
    @instance = YextClient::Calories.new
  end
  ...
  describe 'test an instance of Calories' do
    it 'should create an instact of Calories' do
      expect(@instance).to be_instance_of(YextClient::Calories)
    end
  end
