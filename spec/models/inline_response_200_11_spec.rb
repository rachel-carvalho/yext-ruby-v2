...
# Unit tests for YextClient::InlineResponse20011
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20011' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20011.new
  end
  ...
  describe 'test an instance of InlineResponse20011' do
    it 'should create an instact of InlineResponse20011' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20011)
    end
  end
