...
# Unit tests for YextClient::CustomOption
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomOption' do
  before do
    # run before each test
    @instance = YextClient::CustomOption.new
  end
  ...
  describe 'test an instance of CustomOption' do
    it 'should create an instact of CustomOption' do
      expect(@instance).to be_instance_of(YextClient::CustomOption)
    end
  end
