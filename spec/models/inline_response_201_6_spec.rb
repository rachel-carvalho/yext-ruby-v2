...
# Unit tests for YextClient::InlineResponse2016
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2016' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse2016.new
  end
  ...
  describe 'test an instance of InlineResponse2016' do
    it 'should create an instact of InlineResponse2016' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse2016)
    end
  end
