...
# Unit tests for YextClient::InlineResponse20030Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20030Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20030Response.new
  end
  ...
  describe 'test an instance of InlineResponse20030Response' do
    it 'should create an instact of InlineResponse20030Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20030Response)
    end
  end
