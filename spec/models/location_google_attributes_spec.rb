...
# Unit tests for YextClient::LocationGoogleAttributes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LocationGoogleAttributes' do
  before do
    # run before each test
    @instance = YextClient::LocationGoogleAttributes.new
  end
  ...
  describe 'test an instance of LocationGoogleAttributes' do
    it 'should create an instact of LocationGoogleAttributes' do
      expect(@instance).to be_instance_of(YextClient::LocationGoogleAttributes)
    end
  end
