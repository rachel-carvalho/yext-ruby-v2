...
# Unit tests for YextClient::InlineResponse20024Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20024Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20024Response.new
  end
  ...
  describe 'test an instance of InlineResponse20024Response' do
    it 'should create an instact of InlineResponse20024Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20024Response)
    end
  end
