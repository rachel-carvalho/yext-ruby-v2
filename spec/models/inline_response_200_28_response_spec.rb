...
# Unit tests for YextClient::InlineResponse20028Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20028Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20028Response.new
  end
  ...
  describe 'test an instance of InlineResponse20028Response' do
    it 'should create an instact of InlineResponse20028Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20028Response)
    end
  end
