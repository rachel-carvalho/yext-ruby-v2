...
# Unit tests for YextClient::InlineResponse20017Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20017Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20017Response.new
  end
  ...
  describe 'test an instance of InlineResponse20017Response' do
    it 'should create an instact of InlineResponse20017Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20017Response)
    end
  end
