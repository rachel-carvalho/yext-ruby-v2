...
# Unit tests for YextClient::InlineResponse20021
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20021' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20021.new
  end
  ...
  describe 'test an instance of InlineResponse20021' do
    it 'should create an instact of InlineResponse20021' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20021)
    end
  end
