...
# Unit tests for YextClient::Author
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Author' do
  before do
    # run before each test
    @instance = YextClient::Author.new
  end
  ...
  describe 'test an instance of Author' do
    it 'should create an instact of Author' do
      expect(@instance).to be_instance_of(YextClient::Author)
    end
  end
  ...
  describe 'test attribute "role"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["BUSINESS_REPRESENTATIVE", "CONSUMER"])
