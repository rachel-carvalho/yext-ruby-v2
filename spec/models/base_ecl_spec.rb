...
# Unit tests for YextClient::BaseEcl
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BaseEcl' do
  before do
    # run before each test
    @instance = YextClient::BaseEcl.new
  end
  ...
  describe 'test an instance of BaseEcl' do
    it 'should create an instact of BaseEcl' do
      expect(@instance).to be_instance_of(YextClient::BaseEcl)
    end
  end
