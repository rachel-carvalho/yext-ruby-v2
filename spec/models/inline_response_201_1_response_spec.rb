...
# Unit tests for YextClient::InlineResponse2011Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2011Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse2011Response.new
  end
  ...
  describe 'test an instance of InlineResponse2011Response' do
    it 'should create an instact of InlineResponse2011Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse2011Response)
    end
  end
