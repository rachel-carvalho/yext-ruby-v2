...
# Unit tests for YextClient::ProductSection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductSection' do
  before do
    # run before each test
    @instance = YextClient::ProductSection.new
  end
  ...
  describe 'test an instance of ProductSection' do
    it 'should create an instact of ProductSection' do
      expect(@instance).to be_instance_of(YextClient::ProductSection)
    end
  end
