...
# Unit tests for YextClient::InlineResponse20031
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20031' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20031.new
  end
  ...
  describe 'test an instance of InlineResponse20031' do
    it 'should create an instact of InlineResponse20031' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20031)
    end
  end
