...
# Unit tests for YextClient::InlineResponse20027Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20027Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20027Response.new
  end
  ...
  describe 'test an instance of InlineResponse20027Response' do
    it 'should create an instact of InlineResponse20027Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20027Response)
    end
  end
