...
# Unit tests for YextClient::InlineResponse20013
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20013' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20013.new
  end
  ...
  describe 'test an instance of InlineResponse20013' do
    it 'should create an instact of InlineResponse20013' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20013)
    end
  end
