...
# Unit tests for YextClient::InlineResponseDefault
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponseDefault' do
  before do
    # run before each test
    @instance = YextClient::InlineResponseDefault.new
  end
  ...
  describe 'test an instance of InlineResponseDefault' do
    it 'should create an instact of InlineResponseDefault' do
      expect(@instance).to be_instance_of(YextClient::InlineResponseDefault)
    end
  end
