...
# Unit tests for YextClient::InlineResponse2004Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2004Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse2004Response.new
  end
  ...
  describe 'test an instance of InlineResponse2004Response' do
    it 'should create an instact of InlineResponse2004Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse2004Response)
    end
  end
