...
# Unit tests for YextClient::Duplicate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Duplicate' do
  before do
    # run before each test
    @instance = YextClient::Duplicate.new
  end
  ...
  describe 'test an instance of Duplicate' do
    it 'should create an instact of Duplicate' do
      expect(@instance).to be_instance_of(YextClient::Duplicate)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["POSSIBLE_DUPLICATE", "SUPPRESSION_REQUESTED", "SUPRESSED", "UNAVAILABLE"])
