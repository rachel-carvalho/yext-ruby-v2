...
# Unit tests for YextClient::InlineResponse20019
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20019' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20019.new
  end
  ...
  describe 'test an instance of InlineResponse20019' do
    it 'should create an instact of InlineResponse20019' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20019)
    end
  end
