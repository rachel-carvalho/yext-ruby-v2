...
# Unit tests for YextClient::Bio
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Bio' do
  before do
    # run before each test
    @instance = YextClient::Bio.new
  end
  ...
  describe 'test an instance of Bio' do
    it 'should create an instact of Bio' do
      expect(@instance).to be_instance_of(YextClient::Bio)
    end
  end
