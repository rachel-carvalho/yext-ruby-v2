...
# Unit tests for YextClient::InlineResponse200Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse200Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse200Response.new
  end
  ...
  describe 'test an instance of InlineResponse200Response' do
    it 'should create an instact of InlineResponse200Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse200Response)
    end
  end
