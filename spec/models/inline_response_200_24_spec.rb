...
# Unit tests for YextClient::InlineResponse20024
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20024' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20024.new
  end
  ...
  describe 'test an instance of InlineResponse20024' do
    it 'should create an instact of InlineResponse20024' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20024)
    end
  end
