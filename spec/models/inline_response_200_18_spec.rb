...
# Unit tests for YextClient::InlineResponse20018
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20018' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20018.new
  end
  ...
  describe 'test an instance of InlineResponse20018' do
    it 'should create an instact of InlineResponse20018' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20018)
    end
  end
