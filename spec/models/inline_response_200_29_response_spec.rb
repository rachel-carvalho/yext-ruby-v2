...
# Unit tests for YextClient::InlineResponse20029Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20029Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20029Response.new
  end
  ...
  describe 'test an instance of InlineResponse20029Response' do
    it 'should create an instact of InlineResponse20029Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20029Response)
    end
  end
