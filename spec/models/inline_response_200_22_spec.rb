...
# Unit tests for YextClient::InlineResponse20022
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20022' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20022.new
  end
  ...
  describe 'test an instance of InlineResponse20022' do
    it 'should create an instact of InlineResponse20022' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20022)
    end
  end
