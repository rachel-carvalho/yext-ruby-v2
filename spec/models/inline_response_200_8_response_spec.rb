...
# Unit tests for YextClient::InlineResponse2008Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2008Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse2008Response.new
  end
  ...
  describe 'test an instance of InlineResponse2008Response' do
    it 'should create an instact of InlineResponse2008Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse2008Response)
    end
  end
  describe 'test attribute "linked_account"' do
    it 'should work' do
