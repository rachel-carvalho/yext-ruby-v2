...
# Unit tests for YextClient::InlineResponse20025
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20025' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20025.new
  end
  ...
  describe 'test an instance of InlineResponse20025' do
    it 'should create an instact of InlineResponse20025' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20025)
    end
  end
