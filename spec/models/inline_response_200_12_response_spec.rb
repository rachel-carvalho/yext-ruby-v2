...
# Unit tests for YextClient::InlineResponse20012Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20012Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20012Response.new
  end
  ...
  describe 'test an instance of InlineResponse20012Response' do
    it 'should create an instact of InlineResponse20012Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20012Response)
    end
  end
