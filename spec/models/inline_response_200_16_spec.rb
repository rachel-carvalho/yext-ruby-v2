...
# Unit tests for YextClient::InlineResponse20016
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20016' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20016.new
  end
  ...
  describe 'test an instance of InlineResponse20016' do
    it 'should create an instact of InlineResponse20016' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20016)
    end
  end
