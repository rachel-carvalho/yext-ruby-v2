...
# Unit tests for YextClient::InlineResponse20015
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20015' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20015.new
  end
  ...
  describe 'test an instance of InlineResponse20015' do
    it 'should create an instact of InlineResponse20015' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20015)
    end
  end
