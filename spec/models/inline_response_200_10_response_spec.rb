...
# Unit tests for YextClient::InlineResponse20010Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20010Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20010Response.new
  end
  ...
  describe 'test an instance of InlineResponse20010Response' do
    it 'should create an instact of InlineResponse20010Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20010Response)
    end
  end
