...
# Unit tests for YextClient::InlineResponse20021Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20021Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20021Response.new
  end
  ...
  describe 'test an instance of InlineResponse20021Response' do
    it 'should create an instact of InlineResponse20021Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20021Response)
    end
  end
