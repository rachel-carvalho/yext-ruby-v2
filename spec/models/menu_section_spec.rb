...
# Unit tests for YextClient::MenuSection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MenuSection' do
  before do
    # run before each test
    @instance = YextClient::MenuSection.new
  end
  ...
  describe 'test an instance of MenuSection' do
    it 'should create an instact of MenuSection' do
      expect(@instance).to be_instance_of(YextClient::MenuSection)
    end
  end
