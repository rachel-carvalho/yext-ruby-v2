...
# Unit tests for YextClient::LocationClosed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LocationClosed' do
  before do
    # run before each test
    @instance = YextClient::LocationClosed.new
  end
  ...
  describe 'test an instance of LocationClosed' do
    it 'should create an instact of LocationClosed' do
      expect(@instance).to be_instance_of(YextClient::LocationClosed)
    end
  end
