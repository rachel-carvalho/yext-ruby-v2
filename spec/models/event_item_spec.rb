...
# Unit tests for YextClient::EventItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventItem' do
  before do
    # run before each test
    @instance = YextClient::EventItem.new
  end
  ...
  describe 'test an instance of EventItem' do
    it 'should create an instact of EventItem' do
      expect(@instance).to be_instance_of(YextClient::EventItem)
    end
  end
