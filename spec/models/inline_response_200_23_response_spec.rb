...
# Unit tests for YextClient::InlineResponse20023Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20023Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20023Response.new
  end
  ...
  describe 'test an instance of InlineResponse20023Response' do
    it 'should create an instact of InlineResponse20023Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20023Response)
    end
  end
