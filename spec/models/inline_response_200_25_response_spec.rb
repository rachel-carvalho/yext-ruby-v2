...
# Unit tests for YextClient::InlineResponse20025Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20025Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20025Response.new
  end
  ...
  describe 'test an instance of InlineResponse20025Response' do
    it 'should create an instact of InlineResponse20025Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20025Response)
    end
  end
