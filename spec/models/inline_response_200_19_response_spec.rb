...
# Unit tests for YextClient::InlineResponse20019Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20019Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20019Response.new
  end
  ...
  describe 'test an instance of InlineResponse20019Response' do
    it 'should create an instact of InlineResponse20019Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20019Response)
    end
  end
