...
# Unit tests for YextClient::InlineResponse20031Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20031Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20031Response.new
  end
  ...
  describe 'test an instance of InlineResponse20031Response' do
    it 'should create an instact of InlineResponse20031Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20031Response)
    end
  end
