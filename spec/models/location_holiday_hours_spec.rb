...
# Unit tests for YextClient::LocationHolidayHours
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LocationHolidayHours' do
  before do
    # run before each test
    @instance = YextClient::LocationHolidayHours.new
  end
  ...
  describe 'test an instance of LocationHolidayHours' do
    it 'should create an instact of LocationHolidayHours' do
      expect(@instance).to be_instance_of(YextClient::LocationHolidayHours)
    end
  end
