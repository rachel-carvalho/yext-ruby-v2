...
# Unit tests for YextClient::PublisherAlternateBrands
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PublisherAlternateBrands' do
  before do
    # run before each test
    @instance = YextClient::PublisherAlternateBrands.new
  end
  ...
  describe 'test an instance of PublisherAlternateBrands' do
    it 'should create an instact of PublisherAlternateBrands' do
      expect(@instance).to be_instance_of(YextClient::PublisherAlternateBrands)
    end
  end
