...
# Unit tests for YextClient::GoogleField
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GoogleField' do
  before do
    # run before each test
    @instance = YextClient::GoogleField.new
  end
  ...
  describe 'test an instance of GoogleField' do
    it 'should create an instact of GoogleField' do
      expect(@instance).to be_instance_of(YextClient::GoogleField)
    end
  end
