...
# Unit tests for YextClient::InlineResponse2006Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2006Response' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse2006Response.new
  end
  ...
  describe 'test an instance of InlineResponse2006Response' do
    it 'should create an instact of InlineResponse2006Response' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse2006Response)
    end
  end
