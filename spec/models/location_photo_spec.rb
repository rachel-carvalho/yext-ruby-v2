...
# Unit tests for YextClient::LocationPhoto
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LocationPhoto' do
  before do
    # run before each test
    @instance = YextClient::LocationPhoto.new
  end
  ...
  describe 'test an instance of LocationPhoto' do
    it 'should create an instact of LocationPhoto' do
      expect(@instance).to be_instance_of(YextClient::LocationPhoto)
    end
  end
