...
# Unit tests for YextClient::InlineResponse20028
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20028' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20028.new
  end
  ...
  describe 'test an instance of InlineResponse20028' do
    it 'should create an instact of InlineResponse20028' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20028)
    end
  end
