...
# Unit tests for YextClient::UserAcl
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserAcl' do
  before do
    # run before each test
    @instance = YextClient::UserAcl.new
  end
  ...
  describe 'test an instance of UserAcl' do
    it 'should create an instact of UserAcl' do
      expect(@instance).to be_instance_of(YextClient::UserAcl)
    end
  end
  ...
  describe 'test attribute "on_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["CUSTOMER", "FOLDER", "LOCATION"])
