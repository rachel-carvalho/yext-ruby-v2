...
# Unit tests for YextClient::InlineResponse20017
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20017' do
  before do
    # run before each test
    @instance = YextClient::InlineResponse20017.new
  end
  ...
  describe 'test an instance of InlineResponse20017' do
    it 'should create an instact of InlineResponse20017' do
      expect(@instance).to be_instance_of(YextClient::InlineResponse20017)
    end
  end
