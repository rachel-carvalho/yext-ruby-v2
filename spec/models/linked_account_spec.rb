...
# Unit tests for YextClient::LinkedAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinkedAccount' do
  before do
    # run before each test
    @instance = YextClient::LinkedAccount.new
  end
  ...
  describe 'test an instance of LinkedAccount' do
    it 'should create an instact of LinkedAccount' do
      expect(@instance).to be_instance_of(YextClient::LinkedAccount)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["OK", "EXPIRED"])
