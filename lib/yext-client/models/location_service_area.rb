...
module YextClient
  # Area that is served by this location. It may be specified as a radius from the location's address or as a list of cities and/or postal codes.  **Only for Google My Business:** Currently, **serviceArea** is only supported by Google My Business and will not affect your listings on other sites. 
  class LocationServiceArea
    # The distance around the location that the business serves  **Requires unit:** If the service area is specified with **radius**, a value for **unit** must also be specified. 
    attr_accessor :radius

    # The unit in which radius is measured.  One of: * km - kilometers * mi - miles 
    attr_accessor :unit

    # A list of places served by the location, where each place is either: * a postal code, or * the name of a city. 
