...
module YextClient
  ...
  class Author
    ...
    def valid?
      role_validator = EnumAttributeValidator.new('String', ["BUSINESS_REPRESENTATIVE", "CONSUMER"])
    ...
    def role=(role)
      validator = EnumAttributeValidator.new('String', ["BUSINESS_REPRESENTATIVE", "CONSUMER"])
    ...
    def hash
      [name, profile_url, photo_url, role].hash
    end
