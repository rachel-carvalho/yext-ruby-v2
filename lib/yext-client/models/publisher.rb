...
module YextClient
  ...
  class Publisher
    ...
    def self.swagger_types
      {
        ...
        :'name' => :'String',
        :'url' => :'String',
        :'alternate_brands' => :'Array<PublisherAlternateBrands>',
        :'supported_countries' => :'Array<String>',
        :'supported_location_types' => :'Array<LocationType>',
        :'features' => :'Array<String>',
        :'typical_update_speed' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'supportedLocationTypes')
        if (value = attributes[:'supportedLocationTypes']).is_a?(Array)
          self.supported_location_types = value
        end
      end
      ...
      if attributes.has_key?(:'typicalUpdateSpeed')
        self.typical_update_speed = attributes[:'typicalUpdateSpeed']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          supported_location_types == o.supported_location_types &&
          features == o.features &&
          typical_update_speed == o.typical_update_speed
    end
    ...
    def hash
      [id, name, url, alternate_brands, supported_countries, supported_location_types, features, typical_update_speed].hash
    end
