...
module YextClient
  ...
  class AnalyticsFilter
    ...
    def hash
      [start_date, end_date, location_ids, folder_id, countries, location_labels, platforms, sites, activity_types, actors, min_search_frequency, max_search_frequency, search_term, search_type, foursquare_checkin_type, foursquare_checkin_age, foursquare_checkin_gender, foursquare_checkin_time_of_day, instagram_content_type].hash
    end
