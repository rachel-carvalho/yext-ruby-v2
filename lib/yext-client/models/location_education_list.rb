...
module YextClient
  ...
  class LocationEducationList
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'institutionName')
        self.institution_name = attributes[:'institutionName']
      end

      if attributes.has_key?(:'yearCompleted')
        self.year_completed = attributes[:'yearCompleted']
      end
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ["FELLOWSHIP", "INTERNSHIP", "MEDICAL_SCHOOL", "RESIDENCY"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["FELLOWSHIP", "INTERNSHIP", "MEDICAL_SCHOOL", "RESIDENCY"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          year_completed == o.year_completed
    end
    ...
    def hash
      [type, institution_name, year_completed].hash
    end
