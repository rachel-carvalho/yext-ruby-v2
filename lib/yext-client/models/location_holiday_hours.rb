...
module YextClient
  ...
  class LocationHolidayHours
    ...
    # <msg>The date on which the holiday hours will be in effect</msg>
    attr_accessor :date

    # <msg>Indicates whether the holiday hours are the same as the regular business hours for the given day of the week. If set to true, we will update the holiday hours if the regular business hours change for the given day of the week.</msg>
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isRegularHours')
        self.is_regular_hours = attributes[:'isRegularHours']
      else
        self.is_regular_hours = false
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          hours == o.hours &&
          date == o.date &&
          is_regular_hours == o.is_regular_hours
    end
    ...
    def hash
      [hours, date, is_regular_hours].hash
    end
