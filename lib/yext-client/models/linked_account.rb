...
module YextClient
  ...
  class LinkedAccount
    # ID of this Linked Account.
    attr_accessor :id

    # Publisher ID for this Linked Account.
    attr_accessor :publisher_id

    # Array of Location IDs corresponding to the locations associated with this Linked Account.
    ...
    # The last known status of this account.
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["OK", "EXPIRED"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["OK", "EXPIRED"])
    ...
    def hash
      [id, publisher_id, location_ids, first_name, last_name, email, status].hash
    end
