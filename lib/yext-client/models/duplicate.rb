...
module YextClient
  ...
  class Duplicate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'unavailableReasons')
        if (value = attributes[:'unavailableReasons']).is_a?(Array)
    ...
    def hash
      [id, publisher_id, location_id, url, name, address, phone, latitude, longitude, status, unavailable_reasons].hash
    end
