...
module YextClient
  ...
  class ResponseError
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ["FATAL_ERROR", "NON_FATAL_ERROR", "WARNING"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["FATAL_ERROR", "NON_FATAL_ERROR", "WARNING"])
