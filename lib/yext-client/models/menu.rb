...
module YextClient
  ...
  class Menu
    ...
    # ID of account that owns this ECL.
    attr_accessor :account_id

    # ECL name
    attr_accessor :name

    # ECL title that appears on listings
    attr_accessor :title

    # Number of items in the ECL
    attr_accessor :size
    ...
    def hash
      [id, account_id, name, title, size, publish, currency, sections].hash
    end
