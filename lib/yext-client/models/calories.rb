...
module YextClient
  ...
  class Calories
    ...
    # Calorie count. Must be >= 0 and <= 1000000
    attr_accessor :calorie

    # Specified only if <b>type</b> is RANGE. In that case, this Calories represents a calorie count range from <b>calorie</b> to <b>rangeTo</b>. Must be > <b>calorie</b> and <= 1000000
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'calorie')
        self.calorie = attributes[:'calorie']
      end
