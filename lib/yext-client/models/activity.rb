...
module YextClient
  ...
  class Activity
    # The type of the activity.  See AnalyticsFilter for activity types.
    attr_accessor :type

    # The date and time the activity occurred in ISO 8601 format (yyyy-mm-ddT:hh:mm:ss.000Z)
    attr_accessor :date
    ...
    def hash
      [type, date, location_id, actor, content, details].hash
    end
