...
module YextClient
  ...
  class OptimizationTask
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'locationsEligible')
        self.locations_eligible = attributes[:'locationsEligible']
      end

      if attributes.has_key?(:'locationsCompleted')
        self.locations_completed = attributes[:'locationsCompleted']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          locations_eligible == o.locations_eligible &&
          locations_completed == o.locations_completed
    end
    ...
    def hash
      [id, name, description, locations_eligible, locations_completed].hash
    end
